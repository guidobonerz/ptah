...
ALTER TABLE [{{getNameSpace}}].[{{getCamelCaseName $.Name}}] ADD CONSTRAINT [PK_{{getCamelCaseName $.Name}}] PRIMARY KEY NONCLUSTERED ({{- range $index,$attribute := $pkList }}{{- $attribute.Name}}{{- getArgumentSeparator $index  $pkList}}{{- end}})
GO
